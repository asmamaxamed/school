...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210180758/Untitled-design-(28).png"
            ...
            <div class="report-container"> 
                <div class="report-header"> 
                    <h1 class="recent-Articles">2</h1> 
                    <button class="view">Exams</button> 
                </div> 
                <div class="report-body"> 
                    <div class="report-topic-heading"> 
                        <h3 class="t-op">Exam</h3> 
                    ...
                    <div class="items"> 
                        <div class="item1"> 
                            <h3 class="t-op-nextlvl">Maths Exam</h3> 
                            <h3 class="t-op-nextlvl">05/03/2024</h3> 
                            <h3 class="t-op-nextlvl">09:00 AM</h3> 
                            <h3 class="t-op-nextlvl label-tag">Upcoming</h3> 
                        </div> 
  
                        <div class="item1"> 
                            <h3 class="t-op-nextlvl">Science Exam</h3> 
                            <h3 class="t-op-nextlvl">07/03/2024</h3> 
                            <h3 class="t-op-nextlvl">10:30 AM</h3> 
                            <h3 class="t-op-nextlvl label-tag">Upcoming</h3> 
                        </div> 
                    </div> 
                </div> 
